...
class RandomImageSource(ImageSource): # use this to apply in dreamerv2 
...
def make_img_source(src_type, img_shape, resource_files, total_frames, grayscale): # use this too build repoV2
    if src_type == "color":
